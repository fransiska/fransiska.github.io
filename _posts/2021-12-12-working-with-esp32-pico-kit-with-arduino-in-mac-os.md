...
7. `Tools` -> `Board` -> `ESP32 Arduino` -> `ESP32 Pico Kit`, also select the appropriate `Upload Speed` (115200) and `Port` (`/dev/cu.SLAB_USBtoUART`)
    ...
    <img src="/assets/posts/2021-12-12-working-with-esp32-pico-kit-with-arduino-in-mac-os/esp32.png" width="70%" />
...
<img src="/assets/posts/2021-12-12-working-with-esp32-pico-kit-with-arduino-in-mac-os/arduino_ide.png" width="70%" />
